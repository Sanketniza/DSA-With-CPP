...
int main()
{
 ...
 cout << "Let check the matrix in a sine wave order: " << endl;
    ...
    for (int col = 0; col < 4; col++)
    {
        ...
        if (col & 1)  //? if (col & 1) is used to determine if the variable col is an odd number. If col is odd, the condition will be true, if col is even, the condition will be false.
        {
